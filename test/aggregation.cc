...
void aggregation_load_num_events(db::Table* table) {
  table->Load({
    {"-1", "2", "-257", "145", "-10245", "23456", "-281734", "182745", "1.092743"},
    {"-1", "7", "257", "14", "-10245", "1982", "0", "1111111111", "1.092743"},
    {"-6", "2", "-257", "98", "-98", "777", "198", "0", "7.912435"},
    {"9", "29", "-128", "145", "0", "23456", "-281734", "182745", "139834.12313"}
  });
}
